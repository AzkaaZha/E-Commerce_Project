                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color: rgb(33,37,41); height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="background: url(../img/banner/banner3.png); padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-white">List Produk</h1>
                        </div>
                </div>

                <a class="btn btn-warning" href="form-produk.php" role="button">Create Produk</a><br><br>
                <table class="table table-dark text-center" width="100%" border="1" cellspacing="2" cellpadding="2">
                    <thead>
                    ...
                    <tbody>
                        ...
                        { ?>
                            ...
                            <tr>
                                ...
                                <td class=>
                                    <a class="btn btn-primary" href="view-produk.php?id=<?=$row['id']?>">View</a>
                                    <a class="btn btn-success" href="edit-produk.php?idedit=<?=$row['id']?>">Edit</a>
                                    <a class="btn btn-danger" href="delete-produk.php?iddel=<?=$row['id']?>"
