                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="list-pesanan.php">
                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color: rgb(33,37,41); height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="background: url(../img/banner/banner3.png); padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-white">List Pesanan</h1>
                        </div>
                </div>
                    ...
                    <tbody>
                        ...
                        { ?>
                            ...
                            <tr>
                                ...
                                <td><?=$row['quantity']?></td>
                                <td class=>
                                    <a class="btn btn-primary" href="view-pesanan.php?id=<?=$row['id']?>">View</a>
                                    <a class="btn btn-danger" href="delete-pesanan.php?iddel=<?=$row['id']?>"
                                    onclick="if(!confirm('Anda Yakin Hapus Data Produk <?=$row['nama_pelanggan']?>?')) {return false}"
                                    >Delete</a>
                                </td>
                            </tr>
                        <?php 
