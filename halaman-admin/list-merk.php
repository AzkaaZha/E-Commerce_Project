                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color: rgb(33,37,41); height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="background: url(../img/banner/banner3.png); padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-white">List Merk</h1>
                        </div>
                </div>

                <a class="btn btn-warning" href="form-merk.php" role="button">Create Merk</a><br><br>
                    ...
                    <tbody>
                        ...
                        { ?>
                            ...
                            <tr>
                                ...
                                <td class=>
                                    <a class="btn btn-success" href="edit-merk.php?idedit=<?=$row['id']?>">Edit</a>
                                    <a class="btn btn-danger" href="delete-merk.php?iddel=<?=$row['id']?>"
                                    onclick="if(!confirm('Anda Yakin Hapus Data Merk <?=$row['merk']?>?')) {return false}"
                                    >Delete</a>
                                </td>
                            </tr>
                        <?php 
