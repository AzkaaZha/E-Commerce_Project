        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="form-group row">
                    <label for="nama_motor" class="col-4 col-form-label">Nama</label> 
                    <div class="col-8">
                    <div class="input-group">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="cc" name="cc" type="number" class="form-control" value="<?=$row['cc']?>">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <?php 
                            ...
                            $row2 = $sql2->fetch();
                            echo '<option value="'.$row2['id'].'">'.$row2['merk'].'</option>';
                            }
